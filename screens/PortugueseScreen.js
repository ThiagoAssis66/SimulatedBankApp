...
import questions from '../data/questionsPort.json';
...
const PortugueseScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      {!currentQuestion ? (
        <>
          <Text style={styles.subtitle}>Simulado de Língua Portuguesa!</Text>
          <Image
            source={require('../assets/img/portuguese1.png')}
...
export default PortugueseScreen;