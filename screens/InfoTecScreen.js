...
import questions from '../data/questionsInfo.json';
...
const InfoTecScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      {!currentQuestion ? (
        <>
          <Text style={styles.subtitle}>Simulado de Informática & Tecnologias!</Text>
          <Image
            source={require('../assets/img/info1.png')}
