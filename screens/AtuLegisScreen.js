...
import questions from '../data/questionsAtuLegisBanc.json';
...
const AdmLegisScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      {!currentQuestion ? (
        <>
          <Text style={styles.subtitle}>Simulado de Atualidades & Legislação Bancária!</Text>
          <Image
            source={require('../assets/img/adm1.png')}
